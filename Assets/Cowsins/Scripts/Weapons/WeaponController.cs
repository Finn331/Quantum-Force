...
namespace cowsins
{
    ...
    public class Events
    {
        public UnityEvent OnShoot, onStartReload, OnFinishReload, OnAim, OnAiming, OnStopAim, OnHit, OnInventorySlotChanged, OnEquipWeapon;
    }
    [System.Serializable]
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public void ReleaseCurrentWeapon()
        {
            ...
            weapon = null;
            weaponsInventoryUISlots[currentWeapon].SetWeapon(null);
        }
