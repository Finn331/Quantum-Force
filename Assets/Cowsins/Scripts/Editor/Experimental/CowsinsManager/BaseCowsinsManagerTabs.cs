...
namespace cowsins
{
    public class HomeTab : ITab
    {
        ...
        private void NavBar()
        {
            ...
            EditorGUILayout.HelpBox($"\nCowsins is facing issues with the YouTube channel, so some tutorials are temporarily available on Rumble.\n", MessageType.Warning);
        ...
        private void Home()
        {
            ...
            CowsinsEditorWindowUtilities.DrawTutorialCard(Resources.Load<Texture2D>("CustomEditor/weapon-tutorial"), "https://rumble.com/v6pfpj9-how-to-add-weapons-in-fps-engine-fps-engine-1.3.html?e9s=src_v1_upp", .7f);
            CowsinsEditorWindowUtilities.DrawTutorialCard(Resources.Load<Texture2D>("CustomEditor/BuiltIn"), "https://rumble.com/v6pfq7f-how-to-import-fps-engine-in-unity-6-built-in-render-pipeline-.html?e9s=src_v1_upp", .7f);
            CowsinsEditorWindowUtilities.DrawTutorialCard(Resources.Load<Texture2D>("CustomEditor/URP"), "https://rumble.com/v6pfqjx-how-to-import-fps-engine-in-unity-6-urp-unity-tutorial.html?e9s=src_v1_upp", .7f);
            CowsinsEditorWindowUtilities.DrawTutorialCard(Resources.Load<Texture2D>("CustomEditor/hdrp"), "https://rumble.com/v6pfqcu-how-to-import-fps-engine-in-unity-6-hdrp-unity-tutorial.html?e9s=src_v1_upp", .7f);
            ...
            CowsinsEditorWindowUtilities.DrawLinkCard(Resources.Load<Texture2D>("CustomEditor/CowsinsManager/tutorialsIcon"), "Tutorials", "https://rumble.com/user/CowsinsGames", .77f, .4f);
            GUILayout.FlexibleSpace();
        ...
        private void MoreByCowsins()
        {
            ...
            PackageCard(Resources.Load<Texture2D>("CustomEditor/CowsinsManager/InventorySaveLoadAddOnThumbnail"), "Inventory Pro + Save & Load", 
                ...
                "", "FPS Engine Official Add-On","Coming Soon", Color.green, Color.grey);
